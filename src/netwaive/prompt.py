...
- Pour toute question de comparaison/écart (« quels sites n’ont pas… », « comparer », « manquants », « associés »), utilise `netbox_compare_scoped_relations` et restitue ses totaux/provenances. Ne calcule jamais une différence de collections à partir de listes partiellement visibles ou de noms seuls.
