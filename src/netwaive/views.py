...
def chat(request):
    ...
    return render(request, "netwaive/chat.html", {"plugin_version": "0.5.0-P2", "banner": banner, "widget_title": "NetBox Assistant (Beta)" if english else "Assistant NetBox (Beta)"})
